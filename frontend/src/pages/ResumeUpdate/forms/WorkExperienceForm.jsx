...
const WorkExperienceForm = ({userExperience,updateArrayItem,addArrayItem,removeArrayItem}) => {
  ...
  return (
    <div className='px-5 pt-5'>
        ...
        <div className='mt-4 flex flex-col gap-4 mb-3'>
            { Array.isArray(userExperience) &&userExperience.map((experience,index)=>(
                <div 
                    key={index}
                    ...
                    {userExperience.length>1 && (
                        <button 
                            type="button"
                            className='absolute top-3 right-3 tex-sm text-red-600 hover:underline cursor-pointer'
